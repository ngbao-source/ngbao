...
\033[1;30m\033[3m  Facebook:Ngbao - Zalo:0988467271                                   
    ...
    try:
        ...
        print("\033[38;5;226m[Ng Quang Huy] Bắt đầu gửi tin nhắn...\033[0m")
        
        while True:
            nanh_files = sorted(glob.glob("Ngbaox2006*.txt"))
            
            if not nanh_files:
                print("\033[38;5;196m[!] Không tìm thấy file Ngbaox2006 nào!\033[0m")
                break
            else:
